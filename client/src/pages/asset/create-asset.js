...
function CreateAsset() {
    ...
    const addAsset = (event) => {
        ...
        setIsLoading(true)
        axios.post(`${config.apiBaseurl}/asset`, {
    ...
    return (
        <div className='w-full h-screen px-10'>
            ...
            {!isLoading && <form onSubmit={addAsset}>
                <h1 className='text-left uppercase text-xl font-medium py-5 text-gray-700'>Add Asset</h1>
