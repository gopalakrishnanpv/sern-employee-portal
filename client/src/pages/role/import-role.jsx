...
function ImportRole() {
    ...
    const importRole = (event) => {
        event.preventDefault()
        setIsLoading(true)
        axios.post(`${config.apiBaseurl}/role/bulkcreate`, roles).then((response) => {
        ...
        <div className="w-full h-full">
            ...
            {!isLoading &&
                <div className='w-full h-full px-5'>
                    <h1 className='text-center uppercase text-xl font-medium py-3 text-gray-700'>Import Role</h1>
